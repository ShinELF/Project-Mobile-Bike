...
\t\t";
        // line 16
        yield from         $this->load("layout.twig", 16)->unwrap()->yieldBlock("header", $context);
        yield "
\t\t";
        // line 17
        yield from         $this->load("layout.twig", 17)->unwrap()->yieldBlock("newsletter", $context);
        yield "
\t\t<main>
\t\t\t";
        // line 19
...
\t\t";
        // line 21
        yield from         $this->load("layout.twig", 21)->unwrap()->yieldBlock("footer", $context);
        yield "</body>
</html>
";
        yield from [];
    ...
    {
        return array (  85 => 19,  77 => 21,  74 => 20,  72 => 19,  67 => 17,  63 => 16,  50 => 6,  43 => 1,);
    }
